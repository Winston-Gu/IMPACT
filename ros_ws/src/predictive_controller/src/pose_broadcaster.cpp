...
#include "predictive_controller/pose_broadcaster.hpp"
...
controller_interface::return_type PoseBroadcaster::update(const rclcpp::Time& time,
...
// NOLINTNEXTLINE
PLUGINLIB_EXPORT_CLASS(predictive_controller::PoseBroadcaster,
