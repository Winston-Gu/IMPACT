...
#include <predictive_controller/residual_observer_controller_parameters.hpp>
...
class ResidualObserverController : public controller_interface::ControllerInterface
{
public:
...
private:
  ...
  std::shared_ptr<residual_observer_controller::ParamListener> params_listener_;
  residual_observer_controller::Params params_;
