...
# The device closes its HID handle when the wrapper is torn down.
...
class JoyCon:
    ...
    def __init__(
        self, vendor_id: int, product_id: int, serial: str = None, simple_mode=False
    ):
        ...
        self.serial = serial
        self.simple_mode = simple_mode  # Reporting mode 0x3f.
